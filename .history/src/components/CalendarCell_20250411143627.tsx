...
import { getAbbreviatedSource, groupPublicationsByInstitution } from '@/utils/dateUtils';
...
/**
 * Returns appropriate background color class based on event type
 */
const getEventTypeColor = (type: string): string => {
  const colors: Record<string, string> = {
    ...
    'Market Strategy': 'bg-blue-100 hover:bg-blue-200',
    'Regional Focus': 'bg-indigo-100 hover:bg-indigo-200',
    'Currency Markets': 'bg-teal-100 hover:bg-teal-200',
    'Equity Markets': 'bg-orange-100 hover:bg-orange-200',
    'Fixed Income': 'bg-pink-100 hover:bg-pink-200',
    'Bond Markets': 'bg-violet-100 hover:bg-violet-200',
    'Global Markets': 'bg-cyan-100 hover:bg-cyan-200',
    'Market Analysis': 'bg-lime-100 hover:bg-lime-200',
    'Investment Strategy': 'bg-amber-100 hover:bg-amber-200',
    'Research Focus': 'bg-emerald-100 hover:bg-emerald-200',
    'Cross-Asset': 'bg-fuchsia-100 hover:bg-fuchsia-200',
    'Multi-Asset': 'bg-rose-100 hover:bg-rose-200'
  };
