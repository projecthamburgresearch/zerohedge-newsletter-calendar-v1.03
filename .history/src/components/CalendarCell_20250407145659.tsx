      ...
      >
        ...
        {isPublicationsHovered && remainingPublications.length > 0 && (
          ...
          >
            ...
            <div 
              ref={pubListRef}
              className={`overflow-y-auto scrollbar-none ${remainingPublications.length > 4 ? 'h-[160px]' : ''} -mt-6 -mb-6 pt-6 pb-6`}
              ...
              <div className="space-y-1 px-1">
                {remainingPublications.map((pub, index) => (
                  ...
                  >
                    ...
                    <div className="text-gray-600 mt-1 h-0 overflow-hidden group-hover:h-auto transition-all duration-200">{pub.seriesTitle}</div>
                  </div>
                ))}
              </div>
            </div>
      ...
      >
        ...
        {isEventAreaHovered && remainingEvents.length > 0 && (
          ...
          >
            ...
            <div 
              ref={eventListRef}
              className={`overflow-y-auto scrollbar-none ${remainingEvents.length > 4 ? 'h-[160px]' : ''} -mt-6 -mb-6 pt-6 pb-6`}
              ...
              <div className="space-y-1 px-1">
                {remainingEvents.map((event, index) => (
                  ...
                  >
                    ...
                    <div className="text-gray-600 mt-1 h-0 overflow-hidden group-hover:h-auto transition-all duration-200">{event.type}</div>
                  </div>
                ))}
              </div>
            </div>
