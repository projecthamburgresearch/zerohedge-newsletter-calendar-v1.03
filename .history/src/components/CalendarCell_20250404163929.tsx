...
export const CalendarCell: React.FC<CalendarCellProps> = ({
  ...
  // Scroll pub carousel to specific index
  ...
  // Scroll event carousel to specific index
    ...
    <div className={`p-2 border ${
      ...
      >
        ...
        {isPublicationsHovered && remainingPublications.length > 0 && (
          <div 
            className="absolute z-20 bottom-full left-0 w-full bg-white shadow-lg rounded-md p-2 border mb-1 max-h-[200px] overflow-hidden"
            onMouseEnter={handlePublicationsMouseEnter}
            onMouseLeave={handlePublicationsMouseLeave}
          >
                  ...
                  return (
                    <div
                      ...
                      onMouseEnter={() => {
                        ...
                        // Start auto-scrolling when hovering on non-middle items
                        if (index > 0 && index < remainingPublications.length - 1) {
                          // Don't auto-scroll on top or bottom items
                          return;
                        }
                        ...
                        // Wait a moment before starting auto-scroll
                        pubScrollTimer.current = setTimeout(() => {
                          const scroll = () => {
                            setPubActiveIndex(prev => {
                              const next = prev + direction;
                              // Stop at boundaries
                              if (next < 0 || next >= remainingPublications.length) {
                                return prev;
                              }
                              return next;
                            });
                            ...
                            // Continue scrolling
                            pubScrollTimer.current = setTimeout(scroll, 800);
                          };
      ...
      >
        ...
        {isEventAreaHovered && remainingEvents.length > 0 && (
          <div 
            className="absolute z-20 top-full left-0 w-full bg-white shadow-lg rounded-md p-2 border mt-1 max-h-[200px] overflow-hidden"
            onMouseEnter={handleEventAreaMouseEnter}
            onMouseLeave={handleEventAreaMouseLeave}
          >
            <div className="relative h-full">
                  ...
                  return (
                    <div
                      ...
                      onMouseEnter={() => {
                        ...
                        // Start auto-scrolling when hovering on top or bottom items
                        if (index > 0 && index < remainingEvents.length - 1) {
                          // Don't auto-scroll on middle items
                          return;
                        }
                        ...
                        eventScrollTimer.current = setTimeout(() => {
                          const scroll = () => {
                            setEventActiveIndex(prev => {
                              const next = prev + direction;
                              // Stop at boundaries
                              if (next < 0 || next >= remainingEvents.length) {
                                return prev;
                              }
                              return next;
                            });
                            ...
                            // Continue scrolling
                            eventScrollTimer.current = setTimeout(scroll, 800);
                          };
