  ...
  return (
    <div className={`p-2 border ${
      ...
      >
        ...
        {/* Publications Vertical Dropdown */}
                  ...
                  return (
                    <div
                      ...
                      className={`
                        ...
                        ${isActive ? 'bg-brand-yellow-100' : 'hover:bg-brand-yellow-50'}
                      `}
                      onClick={() => onPublicationClick(pub)}
                      onMouseEnter={() => setActivePublicationIndex(index)}
                    >
                      ...
                      <div className="mt-0.5 text-gray-600 text-[10px] truncate">
                        {pub.seriesTitle}
                      </div>
                    </div>
                  );
                ...
                {remainingEvents.map((event, index) => {
                  ...
                  return (
                    <div
                      ...
                      className={`
                        text-xs p-2 rounded cursor-pointer transition-all
                        ${isActive ? getEventTypeColor(event.type) : 'hover:bg-gray-50'}
                      `}
                    ...
                    >
                      <div className="flex justify-between items-center">
                        ...
                        <span className="text-[9px] text-gray-600">{event.type}</span>
                      </div>
                      <div className="mt-0.5 text-gray-500 text-[10px] truncate">
                        {event.description || ''}
                      </div>
                    </div>
                  );
