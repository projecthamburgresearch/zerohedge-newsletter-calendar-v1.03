      ...
      >
        ...
        {isPublicationsHovered && remainingPublications.length > 0 && (
          ...
          >
            ...
            {/* Carousel container */}
            <div className="relative overflow-hidden max-h-[120px] py-2 px-1">
              <div 
                ref={pubCarouselRef}
                className="flex flex-col transition-transform duration-300 ease-in-out"
                style={{ 
                  transform: `translateY(${-pubCarouselIndex * 50}px)` // Scroll by 50px (38px height + 12px margin)
                }}
              >
                {remainingPublications.map((pub, index) => (
                  <div
                    ...
                    style={{ height: '38px' }} // Keep explicit height
                  >
          ...
          >
            ...
            <div className="relative overflow-hidden max-h-[120px] py-2 px-1">
              <div 
                ...
                className="flex flex-col transition-transform duration-300 ease-in-out"
                style={{ 
                  transform: `translateY(${-eventCarouselIndex * 50}px)` // Scroll by 50px (38px height + 12px margin)
                }}
              >
