      ...
      >
        {currentEvent && (
          <div
            ...
            className="text-xs p-1 rounded cursor-pointer whitespace-nowrap overflow-hidden flex items-center justify-between bg-gray-100 hover:bg-gray-200"
                ...
                <div className="space-y-1 px-1" data-event-list="true">
                  {remainingEvents.map((event, index) => (
                    <div
                      ...
                      className="group text-xs p-2 rounded cursor-pointer bg-gray-100 hover:bg-gray-200"
                    >
