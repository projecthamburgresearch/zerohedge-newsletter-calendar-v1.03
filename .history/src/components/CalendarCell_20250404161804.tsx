      ...
      >
        ...
        {isPublicationsHovered && remainingPublications.length > 0 && (
          ...
          >
            ...
            {/* Carousel container */}
            <div className="relative overflow-hidden" style={{ height: `${Math.min(remainingPublications.length, 3) * 50}px` }}>
              <div 
                ref={pubCarouselRef}
                    ...
                    {remainingPublications.slice(pageIndex * 3, pageIndex * 3 + 3).map((pub, index) => (
                      ...
                      >
                        <div className="flex justify-between items-center">
                          ...
                          <span className="text-[9px] text-gray-500">{pub.newsletterType}</span>
                        </div>
      ...
      >
        ...
        {isEventAreaHovered && remainingEvents.length > 0 && (
          ...
          >
            ...
            {/* Carousel container */}
            <div className="relative overflow-hidden" style={{ height: `${Math.min(remainingEvents.length, 3) * 50}px` }}>
              <div 
