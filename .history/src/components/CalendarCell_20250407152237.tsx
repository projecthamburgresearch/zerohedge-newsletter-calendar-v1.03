        ...
        {isPublicationsHovered && remainingPublications.length > 0 && (
          ...
          >
            <div className="relative">
              ...
              {showPubScrollControls && (
                <button 
                  className={`sticky bottom-0 w-full bg-brand-yellow-100 text-black font-bold py-0.2 text-xs border-t border-gray-200 flex justify-center items-center z-10 hover:bg-brand-yellow-200 ${!showPubDownArrow ? 'opacity-50' : ''}`}
