        ...
        {visiblePublications.map((pub, index) => (
          ...
          >
            <div className="flex-grow truncate">
              ...
              <span className="inline-block truncate align-bottom">{pub.seriesTitle}</span>
            </div>
            {index === 0 && remainingPublications.length > 0 && (
              <span className="flex-shrink-0 inline-block text-center ml-1 bg-brand-yellow-200 rounded-full min-w-[20px] px-1">
