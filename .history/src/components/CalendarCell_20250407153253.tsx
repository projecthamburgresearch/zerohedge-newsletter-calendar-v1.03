          ...
          >
            <div className="relative">
              ...
              {showPubScrollControls && (
                <button 
                  className={`sticky top-0 w-full bg-slate-100 shadow-b-md rounded-md text-black font-bold py-0.2 text-xs border-b border-gray-200 flex justify-center items-center z-10 hover:bg-slate-200 ${!showPubUpArrow ? 'opacity-50' : ''}`}
