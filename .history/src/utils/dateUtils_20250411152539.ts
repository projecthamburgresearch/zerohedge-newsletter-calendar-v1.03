...
export const getPublicationsForDate = (publications: Publication[], date: string): Publication[] => {
  return publications.filter(pub => {
    ...
    // Explicitly check if this is a Publication type to avoid confusion with Events
...
export const getEventsForDate = (events: Event[], date: string): Event[] => {
  return events.filter(event => {
    ...
    // Explicitly check if this is an Event type to avoid confusion with Publications
